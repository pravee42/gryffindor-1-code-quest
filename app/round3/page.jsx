...
export default function Home() {
  ...
  const artifacts = [
    ...
    {name: 'Quidditch Tournament', position: 'top-40 left-[700px]', delay: 0.4},
    {
      name: "Marvolo Gaunt's ring",
      position: 'top-[190px] left-[300px]',
      delay: 0.6,
    },
    {name: "Tom Riddle's Diary", position: 'top-30 right-72', delay: 0.8},
    {name: 'The Sorting Hat', position: 'top-64 right-[400px]', delay: 1.0},
    {name: 'Nagini', position: 'top-96 right-20', delay: 1.2},
    {
      name: "Helga Hufflepuff's cup",
      position: 'bottom-64 right-[500px]',
      delay: 1.4,
    },
    {name: 'Deathly Hallows', position: 'bottom-64 left-72', delay: 1.6},
    {
      name: "Salazar Slytherin's locket",
      position: 'bottom-40 right-[600px]',
      delay: 1.8,
    },
  ];
    ...
    <div className="relative min-h-screen bg-amber-100 overflow-hidden">
      ...
      <motion.div
        ...
        <img
          src="/cobweb.png"
          alt=""
          className="w-full h-full transform scale-x-flip"
        />
      </motion.div>

      <motion.div
        className="absolute top-32 left-32"
        variants={footstepsVariants1}
        initial="initial"
        animate="animate">
        <img
          src="/footprints.png"
        ...
        />
        <p className="text-black">Prem Samosa</p>
      </motion.div>
      ...
      <motion.div
        ...
        <div className="relative min-h-screen">
          ...
          <motion.div
            className="absolute bottom-[0px] left-[0px] w-48 h-48"
            custom={2.0}
            variants={itemVariants}
            initial="hidden"
            animate={isMapRevealed ? 'visible' : 'hidden'}
          ...
          <motion.div
            ...
            <img
              ...
              className="w-16 h-8 opacity-70"
            />
            <p className="text-black">Raj B</p>
          </motion.div>

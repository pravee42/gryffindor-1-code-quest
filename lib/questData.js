...
x → s, y → t, w → r, n → i, s → c, l → e → "secret"`,
  },
  {
    ...
    question: `If the Highest Common Factor of 210 and 55 is expressible in the form 55x - 325x, find x.`,
    correctAnswer: '6',
...
x = 6`,
  },
  {
    ...
    question:
      'Find the Sum of First 19898 Natural Numbers then find the difference with the sum of first 333 Odd Numbers',
